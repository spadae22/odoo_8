...
class product_template(osv.osv):
    ...
    _columns = {
        ...
        'track_incoming': fields.boolean('Track Incoming Lots', help="Forces to specify a Serial Number for all moves containing this product and coming from a Vendor Location"),
