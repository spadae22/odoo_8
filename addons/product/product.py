    ...
    _columns = {
        ...
        'description_purchase': fields.text('Purchase Description',translate=True,
            help="A description of the Product that you want to communicate to your suppliers. "
                 "This description will be copied to every Purchase Order, Receipt and Vendor Invoice/Refund."),
        ...
        'weight': fields.float('Gross Weight', required=True, digits_compute=dp.get_precision('Stock Weight'), help="The gross weight in Lb."),
        'weight_net': fields.float('Net Weight', digits_compute=dp.get_precision('Stock Weight'), help="The net weight in Lb."),
...
class product_supplierinfo(osv.osv):
    ...
    _columns = {
        ...
        'product_name': fields.char('Vendor Product Name', help="This supplier's product name will be used when printing a request for quotation. Keep empty to use the internal one."),
        'product_code': fields.char('Vendor Product Code', help="This supplier's product code will be used when printing a request for quotation. Keep empty to use the internal one."),
